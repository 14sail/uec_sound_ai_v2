...
class ACDNetV2(nn.Module):
    def __init__(self, input_length, n_class, sr, ch_conf=None):
        ...
        conv9, bn9 = self.make_layers(self.ch_config[7], ch_n_class, (1, 1))
...
def GetACDNetModel(input_len=20150, nclass=7, sr=20000, channel_config=None):
...
def GetACDNetQuantModel(input_len=20150, nclass=7, sr=20000, channel_config=None):
